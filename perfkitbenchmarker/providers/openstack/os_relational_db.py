...
"""OpenStack IaaS relational database resource classes."""
...
class OpenStackPostgresIAASRelationalDb(
    postgres_iaas_relational_db.PostgresIAASRelationalDb
):
  """An OpenStack IAAS Postgres database resource."""

  CLOUD = provider_info.OPENSTACK


class OpenStackMysqlIAASRelationalDb(
    mysql_iaas_relational_db.MysqlIAASRelationalDb
):
  """An OpenStack IAAS MySQL database resource."""
