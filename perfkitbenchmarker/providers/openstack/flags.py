...
flags.DEFINE_list(
    ...
    default=[],
    help=(
        'Additional comma separated flags to pass to every '
...
flags.DEFINE_string(
    ...
    'private',
    '(DEPRECATED: Use openstack_network) Name of OpenStack private network.',
)
...
flags.DEFINE_boolean(
    'openstack_boot_from_volume', False, 'Boot from volume instead of an image'
)

flags.DEFINE_integer(
    'openstack_volume_size',
    None,
    '(DEPRECATED: Use data_disk_size) Size of the volume (GB).',
)
...
flags.DEFINE_string(
    'openstack_post_provisioning_script',
    None,
